...
function MainContent() {
  return (
    ...
    <div className='py-24  w-11/12 md:w-1/2  flex mx-auto justify-between   md:px-4'>
    ...
    <div className='w-full  mx-auto grid  md:flex md:justify-between py-8 md:py-12 '>
        <img src='/images/card.png'  className='md:w-1/3 w-5/6 mx-auto py-4 md:py-0  animate__animated animate__fadeIn  animate__delay-1s  animate__slow' />
        <img  src='/images/card2.png' className='md:w-1/3 w-5/6 mx-auto  py-4 md:py-0   animate__animated animate__fadeIn  animate__delay-2s  animate__slow'/>
    </div>
    </div>
  )
}
