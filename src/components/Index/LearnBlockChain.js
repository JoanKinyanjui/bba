  ...
  return (
    <div className='w-11/12 md:w-10/12 mx-auto  py-8 md:py-24'>
        ...
        <div className='grid md:flex w-full items-center md:gap-[10px]'>
            ...
            <div className='w-full mx-auto py-4 md:w-2/3 md:py-0  md:grid md:justify-items-stretch '>
                <img  src='/images/graphic.png' className='px-4 md:mx-auto md:justify-self-center w-full h-full'/>
            </div>
        </div>
    </div>
  )
