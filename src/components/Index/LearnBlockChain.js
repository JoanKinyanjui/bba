    ...
    <div className='w-11/12 md:w-10/12 mx-auto  '>
        ...
        <div className='grid md:flex w-full items-center md:gap-[10px]'>
            ...
            <div className='w-11/12 mx-auto py-4 md:w-2/3 md:py-0'>
                <img  src='/images/graphic.png' className='px-4'/>
            </div>
        </div>
    </div>
  )
